...
export const Badge: React.FC<BadgeProps> = ({ variant, children, className = '' }) => {
  ...
  const variants: Record<BadgeVariant, string> = {
    ...
    rejected: 'bg-red-50 text-red-700 border-red-200 dark:bg-red-950/30 dark:text-red-450 dark:border-red-800/40',
    withdrawn: 'bg-slate-100 text-slate-700 border-slate-250 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700',
    ...
    danger: 'bg-red-50 text-red-700 border-red-200 dark:bg-red-950/30 dark:text-red-450 dark:border-red-800/40',
